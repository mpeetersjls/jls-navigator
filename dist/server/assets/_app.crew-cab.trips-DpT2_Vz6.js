...
function BoardRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/40 group hover:bg-muted/10 transition-colors h-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BoardCell, { editing: isActive("dropoff_datetime"), onClick: () => onActivate("dropoff_datetime"), className: "w-36", children: isActive("dropoff_datetime") ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        autoFocus: true,
        type: "datetime-local",
        ...
        onBlur: (e) => {
          onSave(trip.id, { dropoff_datetime: e.target.value || null });
          onActivate("");
        },
        className: "h-5 w-full rounded border border-border bg-card text-xs focus:outline-none focus:ring-1 focus:ring-primary px-1"
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground whitespace-nowrap", children: fmtDt(trip.dropoff_datetime) }) }),
