...
import { s as supabase, r as reactDomExports, t as toast } from "./router-CaWbYlXL.js";
...
function SharePointSyncSection() {
  ...
  const [syncTarget, setSyncTarget] = reactExports.useState("yachts");
  reactExports.useEffect(() => {
    const n = listName.toLowerCase().trim();
    if (n.includes("tdra") || n.includes("sanitation") || n.includes("gate") || n.includes("cruising") || n.includes("navigation") || n.includes("dma") || n.includes("permit") || n.includes("exit") || n.includes("entry")) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground mt-0.5", children: [
          "App fields: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: syncTarget === "permits" ? "Permits" : syncTarget === "small_boats" ? "Small Boat Registration" : "Yachts" }),
          " · ",
          "Syncs to: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: syncTarget === "yachts" ? "text-primary" : syncTarget === "permits" ? "text-success" : "text-warning", children: syncTarget === "yachts" ? "yachts table" : syncTarget === "permits" ? "permits table" : "small_boats table" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: listName, onChange: (e) => {
          ...
          setColumns([]);
          setMapping({});
        }, placeholder: "List name", className: "h-8 w-36 text-sm" }),
