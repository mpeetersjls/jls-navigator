...
export function CruisingTendersDialog({ yachts, editing, userId, onSaved }: Props) {
  ...
  function buildPayload() {
    return {
      permit_type: "cruising_tenders" as const,
  ...
  async function handleEmailSave() {
    ...
    try {
      ...
      const { data: templates } = await supabase
        ...
        .select("subject, body")
        .eq("permit_type", "cruising_tenders")
  ...
  return (
    <DialogContent className="max-w-4xl">
      <DialogHeader>
        <DialogTitle>
          {editing ? "Edit" : "New"} Cruising Permit — Tenders &amp; Appurtenances
        </DialogTitle>
      </DialogHeader>
      ...
      <form onSubmit={handleSaveOnly}>
        <div className="flex gap-5">
          ...
          <div className="flex-1 grid grid-cols-3 gap-x-4 gap-y-4">
            ...
            <div className="space-y-1.5">
              <Label>Cruising Permit Duration (6 Months)</Label>
              <Input
                type="date"
